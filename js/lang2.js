 document.addEventListener('DOMContentLoaded', function() {
            const mainContainer = document.querySelector('#mainContainer2');
            const countrySelect = document.querySelector('#country2');
            const phoneInput = document.querySelector('#phone2');
            const phoneError = document.querySelector('#phoneError2');
            const nameInput = document.querySelector('#name2');
            const nameError = document.querySelector('#nameError2');
            const emailInput = document.querySelector('#email2');
            const emailError = document.querySelector('#emailError2');
            const agreementInput = document.querySelector('#agreement2');
            const agreementError = document.querySelector('#agreementError2');
            const agreementContainer = document.querySelector('#agreementContainer2');
